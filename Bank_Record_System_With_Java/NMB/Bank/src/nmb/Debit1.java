 ...
 * @author DELL
 */
public class Debit1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(this, "Debit Amount Succesfull.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Debit1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
